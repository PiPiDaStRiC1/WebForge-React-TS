            ...
            <div className="mx-auto max-w-7xl px-6 h-[68px] flex items-center gap-8">
                ...
                <nav className="hidden lg:flex items-center gap-1 flex-shrink-0">
                    <NavLink
                        to="/orders"
                        className={({ isActive }) =>
                            `${isActive ? "text-indigo-600 bg-indigo-50" : "text-gray-600 hover:text-indigo-600 hover:bg-gray-50"} px-4 py-2 text-[15px] font-medium rounded-lg transition-colors`
                        }
                    >
                        Заказы
                    </NavLink>
