...
export const TopUserCard = ({ performer, index }: TopUserCardProps) => {
    ...
    return (
        ...
        >
            <div
                className={`bg-gradient-to-br ${PODIUM_COLORS[index]} rounded-2xl p-6 text-white shadow-2xl hover:-translate-y-2 transition-all duration-300`}
            >
                ...
                <Link
                    ...
                    className="flex justify-center items-center mt-6 mb-4"
                >
                    {isLoadingAvatar && (
                        <div className="absolute w-24 h-24 rounded-full shadow-2xl bg-gray-200 animate-pulse" />
                    )}
                    {performer.picture ? (
                ...
                <div className="text-center">
                    ...
                    <div className="text-sm opacity-90">{performer.completedOrders} заказов</div>
