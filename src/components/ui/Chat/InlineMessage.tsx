                        ...
                        {currentUser.picture ? (
                            <Link to={`/profile/${currentUser.id}`}>
                                <img
                                    ...
                                    className="min-w-8 min-h-8 rounded-full mt-1"
                                />
                            </Link>
                        ) : (
                            <div className="min-w-8 min-h-8 rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center text-white text-4xl font-bold">
