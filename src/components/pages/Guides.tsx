...
import { BookOpen, Clock, Users, Shield, DollarSign, TrendingUp, Zap, Search, ArrowRight, Star } from 'lucide-react';
...
const GUIDES_DATA: Guide[] = [
    // Для заказчиков
    {
        ...
        description: 'Подробное руководство по созданию ТЗ, которое поможет исполнителю точно понять вашу задачу и выполнить её качественно.',
    ...
    },
    {
        ...
        description: 'Критерии оценки исполнителей: рейтинг, портфолио, отзывы, стоимость работ. Как не ошибиться с выбором.',
        category: 'Для заказчиков',
        readTime: '8 мин',
        difficulty: 'Начинающий',
        icon: Users,
    ...
    },
    {
        ...
        description: 'Как правильно общаться, давать обратную связь и контролировать ход работы для достижения лучшего результата.',
        category: 'Для заказчиков',
        readTime: '7 мин',
        difficulty: 'Средний',
        icon: Users,
    ...
    },
    {
        ...
        description: 'Что делать, если результат не устраивает, как запросить доработки и когда обращаться в арбитраж.',
        category: 'Для заказчиков',
        readTime: '12 мин',
    ...
    // Для исполнителей
    {
        ...
        description: 'Как оформить профиль, написать продающее описание, загрузить портфолио и получить первые заказы.',
    ...
    },
    {
        ...
        description: 'Как правильно установить цены на свои услуги, учитывая опыт, конкуренцию и рыночные ставки.',
        category: 'Для исполнителей',
        readTime: '10 мин',
        difficulty: 'Средний',
        icon: DollarSign,
    ...
    },
    {
        ...
        description: 'Практические советы по увеличению рейтинга, получению положительных отзывов и выходу в топ исполнителей.',
        category: 'Для исполнителей',
        readTime: '12 мин',
        difficulty: 'Средний',
        icon: TrendingUp,
    ...
    },
    {
        ...
        description: 'Инструменты и методы для увеличения количества заказов без потери качества. Шаблоны, чек-листы, CRM.',
        category: 'Для исполнителей',
        readTime: '18 мин',
        difficulty: 'Продвинутый',
        icon: Zap,
    ...
    // Оплата и безопасность
    {
        ...
        description: 'Подробное объяснение механизма защиты платежей, этапов сделки и гарантий для обеих сторон.',
    ...
    },
    {
        ...
        description: 'Все доступные методы пополнения счета и вывода заработанных денег. Лимиты, комиссии, сроки.',
        category: 'Оплата и безопасность',
        readTime: '10 мин',
        difficulty: 'Начинающий',
        icon: DollarSign,
    ...
    },
    {
        ...
        description: 'Нужно ли платить налоги с дохода на платформе, как оформить самозанятость или ИП, какие отчеты сдавать.',
        category: 'Оплата и безопасность',
        readTime: '20 мин',
        difficulty: 'Продвинутый',
        icon: BookOpen,
    ...
    },
    {
        ...
        description: 'Распространенные схемы обмана, признаки мошенников, как защитить свой аккаунт и средства.',
        category: 'Оплата и безопасность',
        readTime: '15 мин',
        difficulty: 'Средний',
        icon: Shield,
            ...
            <section className="py-10">
                {filteredGuides.length === 0 ? (
                    <div className="text-center py-20">
                        ...
                        <p className="text-gray-600">Попробуйте изменить запрос или выбрать другую категорию</p>
                    </div>
                ) : (
                                ...
                                >
                                    ...
                                    <div className="p-6">
                                        <div className="flex items-center justify-between mb-3">
                                            ...
                                            <span className={`text-xs font-semibold px-2 py-1 rounded-lg ${DIFFICULTY_COLORS[guide.difficulty]}`}>
                                                {guide.difficulty}
                                            </span>
                                        </div>
            ...
            {/* <section className="py-16">
                <div className="bg-gradient-to-br from-indigo-500 to-purple-600 rounded-3xl p-8 md:p-12 text-center text-white relative overflow-hidden">
                    ...
                    <div className="relative">
                        ...
                        <h2 className="text-3xl font-bold mb-4">Хотите предложить тему для гайда?</h2>
                        <p className="text-white/90 mb-6 max-w-2xl mx-auto">
                            Напишите нам, какие темы вас интересуют, и мы создадим подробное руководство
                        </p>
                        <button
                            type="button"
