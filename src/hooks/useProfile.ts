...
export const useProfile = () => {
    ...
    const handleSave = async () => {
        ...
        try {
            await changeUserData(Object.entries(changedData) as [keyof UserData, UserData[keyof UserData]][], signal)
    ...
    const handleChangeFreelancer = <T extends keyof FreelancerData>(field: T, value: FreelancerData[T]) => {
        setChangedData(prev => ({
            ...prev,
            [field]: value,
        }));
    ...
    return { isEditing, isSaving, changedData, handleEdit, handleSave, handleAbort, handleChangeBaseUser, handleChangeFreelancer, handleLogOut, handleExit  };
}