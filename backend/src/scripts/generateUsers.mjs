...
function generateClients(count) {
    ...
    clientsRaw.forEach((user, idx) => {
        ...
        clientsById[id] = {
            ...
            experience: null,
            category: null,
            status: faker.helpers.arrayElement(["verified", "busy", "unverified"]),
            statusChat: faker.helpers.arrayElement(["offline", "online"]),
...
function generateFreelancers(count, startId = 1000) {
    ...
    freelancersRaw.forEach((user, idx) => {
        ...
        freelancersById[id] = {
            ...
            pricePerHour,
            experience: yearsExp,
            status: faker.helpers.arrayElement(["verified", "busy", "free", "unverified"]),
            statusChat: faker.helpers.arrayElement(["offline", "online"]),
...
fs.writeFileSync(
    outputPath,
    JSON.stringify({ clientsById, allClientsIds, freelancersById, allFreelancersIds }, null, 2),
    "utf-8",
);
