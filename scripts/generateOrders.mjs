...
const CATEGORIES = [
    {
        id: "web-dev",
        name: "Веб-разработка",
        subcategories: ["React", "Vue", "Angular", "Node.js", "PHP", "Python"],
    },
    {
        id: "design",
        name: "Дизайн",
        subcategories: ["UI/UX", "Графический дизайн", "Логотипы", "Брендинг"],
    },
    {
        id: "marketing",
        name: "Маркетинг",
        subcategories: ["SMM", "Контент-маркетинг", "Email-маркетинг"],
    },
    {
        id: "mobile",
    ...
    },
    {
        id: "seo",
        name: "SEO",
        subcategories: ["Аудит сайта", "Внутренняя оптимизация", "Внешняя оптимизация"],
    },
    {
        id: "data",
        name: "Аналитика данных",
        subcategories: ["Data Science", "Машинное обучение", "Визуализация данных"],
    },
];
...
function generateOrders() {
    return Object.fromEntries(
        Array.from({ length: ORDERS_COUNT }, (_, i) => {
            ...
            const selectedFreelancer =
                status === "completed"
                    ? faker.helpers.arrayElement(Object.values(freelancersById))
                    : null;
            ...
            return [
                i + 1,
                {
                    ...
                    skills: faker.helpers.arrayElements(selectedCategory.subcategories, {
                        min: 2,
                        max: 4,
                    }),
                    status: status,
...
fs.writeFileSync(
    outputPath,
    JSON.stringify(
        { ordersById: orders, allIds: Array.from({ length: ORDERS_COUNT }, (_, i) => i + 1) },
        null,
        2,
    ),
    "utf-8",
